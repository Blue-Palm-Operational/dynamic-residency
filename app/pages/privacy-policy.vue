    ...
    <main class="max-w-3xl mx-auto px-6 py-24">
      ...
      <div class="space-y-10 text-[var(--ink)]/80 text-sm leading-relaxed">
        ...
        <section>
          ...
          <p class="mb-4">Viele Unternehmen finanzieren ihre Dienstleistungen durch die Sammlung, Analyse, Weitergabe oder Monetarisierung persönlicher Informationen. Nutzer werden dabei häufig zu Produkten, deren Verhalten ausgewertet, gespeichert und vermarktet wird.</p>
          <p class="mb-4">Wir verfolgen einen anderen Ansatz.</p>
          <p>Bei Dynamic Residency betrachten wir Privatsphäre nicht als gesetzliche Pflicht, sondern als grundlegendes Menschenrecht.</p>
          <p class="mt-2">Unser Ziel besteht nicht darin, möglichst viele Daten zu sammeln. Unser Ziel besteht darin, unsere Dienstleistungen mit möglichst wenig Wissen über unsere Nutzer bereitzustellen.</p>
        </section>
        ...
        <section>
          ...
          <ul class="space-y-1 mb-4">
            ...
            <li>Nicht Investoren.</li>
            <li>Nicht Werbenetzwerken.</li>
            <li>Nicht Datenhändlern.</li>
            <li>Nicht Regierungen.</li>
            <li>Nicht zukünftigen Käufern unseres Unternehmens.</li>
          </ul>
          <p>Die Informationen, die Sie uns anvertrauen, bleiben Ihre Informationen. Wir betrachten uns lediglich als zeitweilige Verwalter dieser Daten, niemals als Eigentümer.</p>
        </section>
        ...
        <section>
          ...
          <ul class="space-y-1 mb-4">
            <li>Heute nicht.</li>
            <li>Morgen nicht.</li>
            <li>Auch nicht in Zukunft.</li>
          </ul>
          <p class="mb-2">Wir verkaufen keine personenbezogenen Daten. Wir vermieten keine personenbezogenen Daten. Wir tauschen keine personenbezogenen Daten gegen Dienstleistungen.</p>
          <p>Wir betreiben keine versteckten Geschäftsmodelle, die auf der Auswertung oder Vermarktung persönlicher Informationen beruhen. Ihre Daten sind kein Handelsgut.</p>
        </section>
        ...
        <section>
          ...
          <ul class="space-y-1 mb-4">
            ...
            <li>Wir verfolgen nicht jede Mausbewegung.</li>
            <li>Wir zeichnen keine Sitzungen auf.</li>
            <li>Wir erstellen keine detaillierten Verhaltensprofile.</li>
            <li>Wir analysieren nicht, welche Inhalte Sie am längsten betrachten, um psychologische Profile zu erstellen.</li>
            <li>Wir sammeln keine Daten aus bloßer Neugier.</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul class="space-y-1 mb-4">
            ...
            <li>Wir bewerten nicht Ihre religiösen Überzeugungen.</li>
            <li>Wir bewerten nicht Ihre Weltanschauung.</li>
            <li>Wir bewerten nicht Ihre sozialen Beziehungen.</li>
            <li>Wir bewerten nicht Ihre psychologischen Eigenschaften.</li>
            <li>Wir bewerten nicht Ihren Charakter.</li>
            <li>Wir bewerten nicht Ihren Wert als Mensch.</li>
          </ul>
          <p>Wir glauben, dass Menschen mehr sind als Datensätze.</p>
        </section>
        ...
        <section>
          ...
          <ul class="space-y-1 mb-4">
            ...
            <li>abgesicherte Serverinfrastrukturen,</li>
            <li>strenge Zugriffskontrollen,</li>
            <li>regelmäßige Sicherheitsüberprüfungen,</li>
            <li>kontinuierliche Überwachung sicherheitsrelevanter Vorfälle,</li>
            <li>Prinzipien minimaler Zugriffsrechte,</li>
            <li>interne Sicherheitsrichtlinien.</li>
          </ul>
          <p>Dennoch werden wir niemals behaupten, absolute Sicherheit garantieren zu können. Was wir garantieren können, ist unser kontinuierlicher Einsatz, Risiken zu minimieren und Sicherheitsstandards laufend zu verbessern.</p>
        </section>
        ...
        <section>
          ...
          <ul class="space-y-1 mb-4">
            ...
            <li>warum sie gespeichert werden,</li>
            <li>wie lange sie gespeichert werden,</li>
            <li>wer darauf zugreifen kann,</li>
            <li>wann sie gelöscht werden.</li>
          </ul>
          <p>Vertrauen entsteht nicht durch Geheimhaltung. Vertrauen entsteht durch Offenheit.</p>
        </section>
        ...
        <section>
          ...
          <ul class="space-y-1 mb-4">
            ...
            <li>Zugriffe werden auf das notwendige Minimum beschränkt.</li>
            <li>Jeder Zugriff muss einen legitimen geschäftlichen Zweck haben.</li>
          </ul>
          <p>Privatsphäre beginnt innerhalb eines Unternehmens.</p>
        </section>
        ...
        <section>
          ...
          <ul class="space-y-1">
            ...
            <li>politischem Missbrauch,</li>
            <li>wirtschaftlicher Ausnutzung.</li>
          </ul>
        </section>
...
useHead({ title: 'Datenschutz-Charta — Dynamic Residency' })
</script>
